...
def show_acc(request):
    ...
    return render(request, 'trading/new_instid.html', {'accountinfos': accountinfos})


@islogin
def new_instid_start_trade(request):
    if request.method == 'POST':
        instId = request.POST.get('new_instId', '').strip().upper()
